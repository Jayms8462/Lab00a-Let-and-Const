...
function displayPics(){
  ...
  // Let is a variable declaration that is tied to the block of the code, in this case it only applies to the while loop, where var applies to the entire function of where the variable was declared in this case in the function of displaypics().
  console.log(viewed);
